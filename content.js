...
const SITE = {
  ...
  "posts": [
    ...
    },
    {
      ...
      "updates": [
        {
          "date": "2026-09-05T17:48",
          "content": "<h1>Assembly day</h1>\n<p><em>Date: September 5, 2026</em></p>\n\n<h2>Summary</h2>\n<p>Today we worked on populating and soldering our addressable LED board using the custom stencil we cut out last night. Solder paste was applied to the board, components were placed into position, and the board was heated with a hot air station to reflow the solder. However, alignment errors and solder bridging caused multiple short circuits, leaving the board currently non-operational.</p>\n\n<h2>Process Log</h2>\n\n<h3>1. Solder Paste Alignment Error</h3>\n<p><img src=\"assets/images/pasted-1788640854144.png\" alt=\"Solder paste placed offset by one row\"></p>\n<p><em>Figure 1: Solder paste applied to the board, accidentally offset by one row.</em></p>\n\n<h3>2. Component Placement</h3>\n<p><img src=\"assets/images/pasted-1788641144155.png\" alt=\"Magnus placing diodes on solder paste\"></p>\n<p><em>Figure 2: Magnus carefully placing diodes onto the correctly realigned solder paste pads before reflow.</em></p>\n\n<h3>3. Reflow and Short Circuit Troubleshooting</h3>\n<p><img src=\"assets/images/pasted-1788640896626.png\" alt=\"Attempting to clear short circuits\"></p>\n<p><img src=\"assets/images/pasted-1788640935821.png\" alt=\"Clearing tiny solder bridges\"></p>\n<p><em>Figures 3 & 4: Inspecting and attempting to fix tiny short circuits created during hot air reflow.</em></p>\n\n<h2>Current Status and Next Steps</h2>\n<p>The board is currently not working due to unidentified shorts across the traces. The lack of a solder mask on our CNC milled board makes solder bridging much easier during reflow.</p>\n\n<ul>\n  <li>Continue troubleshooting and isolating the remaining short circuits on this board.</li>\n  <li>Alternatively, remake the PCB using laser etching instead of CNC milling to achieve cleaner isolation lines and reduce bridging..</li>\n</ul>"
        },
        {
          "date": "2026-09-17T15:50",
          "content": "<h1>Finding the source of the issue </h1>\n<img src=\"assets/images/pasted-1789660558196.png\" alt=\"\">\n<p>\nits funny how much more apparent the issue on my home microscope. its obvious that the surface tencion of the solder did not pull the components into place as much as we though they would \n</p>\n<img src=\"assets/images/pasted-1789660725214.png\" alt=\"\">\n<p>\nmy next task is to perhaps going trough all of them and estimating the damage to figure out if its worth it to sort this out by hand or to just start from the beginning\n</p>\n\n"
        }
      ],
